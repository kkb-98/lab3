...
#include <fcntl.h>
#include <time.h>
#define BUFSIZE 512 /* 읽혀질크기 */

char practice_1[BUFSIZE] = "Don’t judge a book by its cover";
char practice_2[BUFSIZE] = "Strike while the iron is hot";
char practice_3[BUFSIZE] = "Too many cooks spoil the broth";
